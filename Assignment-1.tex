...
\item Construct $\triangle ABC$ such that $AC$ = 3,$\angle{A}$ = \ang{70} and $\angle{B}$ = \ang{50}.
%
...
Now we shall find the side $c$ by using the formula
...
\\
&= 3 \brak{\frac{\sin{\ang{60}}}{\sin{\ang{50}}}}
\\
&= 3.3915
\end{align}
...
\begin{align}
\mymacro\vec{A} = \myvec{0 \\ 0},
\mymacro\vec{B} = \myvec{c\cos{\ang{70}} \\ c\sin{\ang{70}}},
\mymacro\vec{C} = \myvec{3 \\ 0}
\end{align}
\\
